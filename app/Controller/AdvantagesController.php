...
class AdvantagesController extends AppController{
	public $uses = array('Category', 'Advantage');
	...
	public function index(){
		...
		$order = array('Advantage.sort_order DESC');
		$paginator = array();
	...
	public function view($id){
		...
		$other_advantage = $this->Advantage->find('all', array(
			'conditions' => array(array('Advantage.id !=' => $id)),
			'limit' => 6,
		));
		...
		$this->set(compact('data', 'title_for_layout', 'other_advantage', 'meta'));
	}
