            ...
            <tbody>
  			 	  ...
  			 	  <?php foreach($data as $item): ?>
    					...
    					<td class="project-actions text-right">
    						<a class="btn btn-info btn-sm" href="/admin/settings/edit/<?=$item['Setting']['id']?>?lang=ru">
    							<i class="fas fa-pencil-alt">
    							</i>
    							Рус
    						</a>
                <a class="btn btn-info btn-sm" href="/admin/settings/edit/<?=$item['Setting']['id']?>?lang=kz">
                  <i class="fas fa-pencil-alt">
                  </i>
                  Кз
                </a>
    					...
    					<!-- 	<?php echo $this->Form->postLink('Удалить', array('action' => 'admin_delete', $item['Setting']['id']), array('confirm' => 'Подтвердите удаление','value'=>'465','class' => 'btn btn-danger btn-sm')); ?> -->
    					</td>
    					</tr>
    				<?php endforeach ?>
