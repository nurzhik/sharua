...
<head>
        ...
        <div class="header-top-out">
            <div class="container">
                <div class="header-top">
                    ...
                    <div class="lang">
                        <a href="#ru" class="lang__item lang__center lang-active">RU</a>
                        <a href="#kaz" class="lang__item">Kaz</a>
                        <a href="#eng" class="lang__item">Eng</a>
                    </div>
                    <div class="header-call general-call">
                        <a href="#" class="call-icon"></a>
                        <div class="call-in-block">
                            <a href="#">+7 (707) 656 89 87</a>
                            <span>Пн-Сб с 9:00 до 20:00</span>
                        </div>
                    </div>
                    <div class="header-socials gineral-socials">
                        <a class="socials__item instagram" href="#"></a>
                        <a class="socials__item youtube" href="#"></a>
                    </div>
                    ...
                    <a data-fancybox="" data-src="#id-add-cop" href="javascript:;" class="join">
                        ...
                        <span> Вступить в кооператив </span>
                    </a>
        ...
        <ul class="header-bottom menu">
            ...
            <li class="menu-abouts">
                ...
                <ul class="menu-about-links">
                    ...
                    <li> <a href="about__rules.html">Правила вступления</a> </li>
                    <li> <a href="about__projects.html"> Наши проекты  </a> </li>
                </ul>
            </li>
            ...
            <div class="container">
                <div class="footer-top-block">
                    ...
                    <div class="footer-call general-call ">
                        <a href="#" class="call-icon"></a>
                        <div class="call-in-block">
                            <a href="tel:+77076568987">+7 (707) 656 89 87</a>
                            <span>Пн-Сб с 9:00 до 20:00</span>
                        </div>
                    </div>
                    <div class="footer-call general-call ">
                        ...
                        <div class="call-in-block emaill-in-block">
                            <a href="#">info@sharua-mekeni.kz</a>
        ...
        <div class="container">
            <div class="footer-bottom">
                <div class="footer-left">
                    <div class="footer-left-p">Sharua Mekeni 2020 © Все права защищены</div>
                    <div class="footer-left-p-1"> Сайт создан <a href="https://astanacreative.kz/" target="_blank"> AstanaCreative </a></div>
                </div>
    ...
    <div class="id-add-cop okno" id="id-add-cop" style="display: none;">
        <div class="okno-top">
            <div class="onkno__title">Регистрация</div>
        ...
        <form class="okno-center" action="/users/registration" method="POST" enctype="multipart/form-data">
            <div class="okno-grid">
                <div class="okno-input">
                    <div class="okno-input__title">Фотография пользователя:</div>
                    <label for="dwn">
                ...
                <div class="okno-input">
                    <div class="okno-input__title">ИИН:</div>
                    <input type="text" name="data[User][iin]" required placeholder="Введите ваш ИИН">
                </div>
    
                <div class="okno-input">
                    <div class="okno-input__title">ФИО:</div>
                    <input type="text" name="data[User][fio]" required placeholder="Фамилия, Имя, Отчество">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Электронная почта</div>
                    <input type="text" name="data[User][username]" required placeholder="Ваша электронная почта">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Ваш город:</div>
                    <input type="text" name="data[User][city]" required placeholder="Фамилия, Имя, Отчество">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Ваш адрес:</div>
                    <input type="text" name="data[User][address]" required placeholder="Фамилия, Имя, Отчество">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Ваш телефон:</div>
                    <input type="text" name="data[User][phone]" required placeholder="Фамилия, Имя, Отчество">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Номер договора:</div>
                    <input type="text" name="data[User][contract]"  required placeholder="ХХХ ХХХ ХХХ ХХХ ХХХ">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Пидумайте пароль:</div>
                    <input type="password"  name="data[User][password]"required >
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Повторите пароль:</div>
                    <input type="text" name="data[User][password_repeat]" required>
                </div>
            </div>
            <button class="okno-btn" type="submit"> Зарегистрироваться </button>
        </form>
    </div>
    <div class="exite-popap" id="exite-popap" style="display: none;">
        <div class="okno-top">
            <div class="onkno__title">Вход</div>
            <a href="cabinet__plan-calculation.html">
        ...
        <form class="okno-center" action="/users/login" method="POST">
           <div class="exite-block">
                <div class="okno-input">
                    <div class="okno-input__title">Логин:</div>
                    <input type="text" name="data[User][username]"  required placeholder="Введите электронный адрес">
                </div>
                <div class="okno-input">
                    <div class="okno-input__title">Пароль:</div>
                    <input type="text" name="data[User][password]" placeholder="Введите ваш пароль">
                </div>
                <button class="okno-btn" type="submit"> Зарегистрироваться </button>
                <a class="link-registr" href="#"> Забыл пароль </a>
           </div>
        </form>
    </div>
    <div class="zayavka-popap" id="zayavka" style="display: none;">
        <div class="exite-popap">
            <div class="okno-top">
                <div class="onkno__title">Оставить заявку</div>
                <a href="#">
                    <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.875 17C20.1523 17 22 15.1523 22 12.875V4.625C22 2.34766 20.1523 0.5 17.875 0.5H14.2656C13.9648 0.5 13.75 0.757812 13.75 1.01562V2.73438C13.75 3.03516 13.9648 3.25 14.2656 3.25H17.875C18.6055 3.25 19.25 3.89453 19.25 4.625V12.875C19.25 13.6484 18.6055 14.25 17.875 14.25H14.2656C13.9648 14.25 13.75 14.5078 13.75 14.7656V16.4844C13.75 16.7852 13.9648 17 14.2656 17H17.875ZM15.8555 8.36328L8.63672 1.14453C7.99219 0.5 6.875 0.972656 6.875 1.875V6H1.03125C0.429688 6 0 6.47266 0 7.03125V11.1562C0 11.7578 0.429688 12.1875 1.03125 12.1875H6.875V16.3125C6.875 17.2578 7.99219 17.6875 8.63672 17.043L15.8555 9.82422C16.2422 9.4375 16.2422 8.79297 15.8555 8.36328Z" fill="#EF811F"></path>
                    </svg>
            ...
            <form class="okno-center" action="">
               <div class="exite-block">
                    <div class="okno-input">
                        <div class="okno-input__title">Имя:</div>
                        <input type="text" placeholder="Введите электронный адрес">
                    </div>
                    <div class="okno-input">
