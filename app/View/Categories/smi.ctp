<section class="page breadcrumbs_section">
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li><a><?=__('СМИ о нас')?></a></li>
        </ul>
        <div class="title title_left"><?=__('СМИ о нас')?></div>
    </div>
</section>
...
<section>
    <div class="container">
        <div class="news_cat">
            <a class="news_cat_item " href="/<?=$lang?>news"><?=__('Новости')?></a>
            <a class="news_cat_item active" href="/<?=$lang?>smi"><?=__('СМИ о нас')?></a>
        </div>
        <div class="news">
    ...
    <div class="container">
        <div class="pressa">
            ...
            <div class="pressa_contact">
                ...
                <div class="contact_item">
                    <div class="contact_name">Приемная:</div>
                    <a class="left_icon tel" href="tel:+77172999471">+7 7172 999 471</a>
                </div>
            </div>
            <div class="text_item">
                <p>
                <?=__('Для получения более подробной информации по работе пресс-службы обращайтесь по выше указанным контактам')?> </p>
            </div>
        </div>
    </div>
</section>