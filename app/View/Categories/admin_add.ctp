      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
    			...
    			<div class="form-group">
    				...
    				<input type="text" id="inputName" class="form-control" required="required" name="data[Category][title_ru]"  >
    			</div>
          <div class="form-group">
            <label for="inputNameKZ">Название kz</label>
            <input type="text" id="inputNameKZ" class="form-control" required="required" name="data[Category][title_kz]"  >
          </div>
