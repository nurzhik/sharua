            ...
            <div class="chat_block">
                <div class="chat_head pacient_chat_head">
                    <div class="chat_head_doc">
                        <div class="res_item_img">
                            <img src="/img/users/<?=$user_to['User']['surname']?>" alt="">
                        </div>
                        <div class="res_item_text">
...
<!--                    </div>-->
                ...
                <div class="chat_bottom" action="" method="">
                    ...
                    <input id="chat_file_input" type="file" name="file" >
                    <textarea id="input" class="chat_message" rows="1" placeholder="Введите сообщение" required></textarea>
...
$.ajax({
            ...
            //    //Проверяем вспомогательную переменную
            //         console.log(data);
