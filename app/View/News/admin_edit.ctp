          ...
          <div class="form-group">
              ...
              <select name="data[News][category_id]"  id="selectRegion" class="form-control custom-select">
                 ...
                 <?php foreach ($categories as $item): ?>
                   <option value="<?=$item['Category']['id']?>" <?=  ($data['News']['category_id']  == $item['Category']['id']) ? 'selected' : '' ?> ><?=$item['Category']['title_ru']?></option>
                <?php endforeach ?>
          ...
          <div class="form-group">
            ...
            <textarea id="editor3" class="form-control"  name="data[News][short_text]" ><?=(!empty($data['News']['short_text'])) ? $data['News']['short_text'] : '' ?></textarea>
    			...
    			<div class="form-group">
    				...
    				<textarea id="editor2" class="form-control"  name="data[News][body]" ><?=(!empty($data['News']['body'])) ? $data['News']['body'] : '' ?></textarea>
    			</div>
          <div class="form-group">
              <label>Дата :</label>
