...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 30 2021 г., 07:45
...
CREATE TABLE `planneds` (
  ...
  `first_quarter` bigint(20) NOT NULL,
  `second_quarter` bigint(20) NOT NULL,
  `third_quarter` bigint(20) NOT NULL,
  `fourth_quarter` bigint(20) NOT NULL,
  `year` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `planneds`
--

INSERT INTO `planneds` (`id`, `title_ru`, `title_kz`, `type`, `first_quarter`, `second_quarter`, `third_quarter`, `fourth_quarter`, `year`) VALUES
(1, 'Выручка от реализации переработанного молока', 'Выручка от реализации переработанного молока', 'income', 12, 12, 12, 12, 2021);
...
INSERT INTO `users` (`id`, `role`, `username`, `active`, `password`, `forgetpwd`, `img`, `fio`, `phone`, `iin`, `address`, `city`, `activation`, `contract`, `created`, `modified`) VALUES
(1, 'admin', 'admin', '', '$2a$10$eujN90i9HDNEGiMmOnW75.FrHNecBYn/b8SfwJJluuPFX2Cq0J.n2', NULL, '', '', '', NULL, NULL, NULL, 'deactivate', NULL, '2015-09-15 13:51:15', '2015-09-15 13:51:15'),
(41, 'user', 'test@mail.ru', 'deactivate', '$2a$10$KJ8wApy3D0YbVd4Vs58SyOdwkqHsFXCHA99VGVnFF5g1envi1ZNOq', '819247', NULL, 'ТЕстовый', '+7 (333) 333 33 33', 123, NULL, NULL, 'deactivate', NULL, '2021-03-09 14:19:18', '2021-03-09 14:19:18'),
(42, 'moderator', 'moderator@mail.ru', 'deactivate', '$2a$10$0ipkXRO7/isvM1Ad2lA2ougd1ipm4vT0KSbxf8OOf0SG6rmvDu8YK', NULL, NULL, 'МОдератор 1', NULL, NULL, NULL, NULL, 'deactivate', NULL, '2021-03-18 13:09:17', '2021-03-18 13:09:17'),
(43, 'moderator', 'moderator2@mail.ru', 'deactivate', '$2a$10$7iS2WyOoqUKriUNypD8pZub5PEh8TY173f/o.wnG6a5PtnmyvJ1rq', NULL, NULL, 'МОдератор 2', NULL, NULL, NULL, NULL, 'deactivate', NULL, '2021-03-18 13:10:00', '2021-03-18 13:10:00'),
(44, 'user', 'client2@mail.ru', 'activate', '$2a$10$ICaam2NX8m3yfs7urrf1zuddp9mZDr14/xHvEwFLWoFQx/y8QB3A6', '889285', NULL, 'Клиент2 ', '+7 (777) 777 77 77', 940309350448, NULL, NULL, 'deactivate', NULL, '2021-03-19 14:09:33', '2021-03-19 14:09:33'),
(46, 'user', 'nurzhananuarbek@mail.ru', 'deactivate', '$2a$10$j6G.ZEUKQsrGRm56NN8gOOoDo7esQSAqckdIqzLKWvM7ghvQUFvlS', '598477', NULL, 'Клиент3', '+7 (777) 777 77 77', 940309350448, 'Петрова 13', 'Астана', 'deactivate', NULL, '2021-03-26 12:54:07', '2021-03-26 13:42:04'),
(47, 'user', 'client6@mail.ru', 'deactivate', '$2a$10$qPDA4xnG6cmYugPl/yENJO3QSwlgnVkb4doUyuxuMA9uTAhbUbYC2', '945974', NULL, 'Клиент6', '+7 (232) 137 77 77', 940309350448, 'Петрова 13', 'Астана', 'deactivate', '333333333333333', '2021-03-29 13:27:23', '2021-03-29 13:27:23'),
(48, 'user', 'client3@mail.ru', 'deactivate', '$2a$10$4U039ID1Vw9wCpu889uEHeO6pr86iq5XaseZnSG8DKx0tKMInSO9i', '447964', NULL, 'Клиент2 ', '+7 (777) 777 77 77', 940309350448, 'Петрова 13', 'Астана', 'deactivate', '444444444444444444', '2021-03-29 13:34:02', '2021-03-29 13:34:02'),
(49, 'user', 'client1@mail.ru', 'deactivate', '$2a$10$VXiz.FW0219f9hoh0QOzdOlDeKwsdR54CARc6AqfiMQLxJ.XrmQI6', '203738', NULL, 'Клиент2 ', '+7 (777) 777 77 77', 940309350448, 'Петрова 13', 'Астана', 'deactivate', '444444444444444444', '2021-03-29 13:34:55', '2021-03-29 13:34:55'),
(50, 'user', 'client20@mail.ru', 'deactivate', '$2a$10$UNYMosSk/aBlINpEJtfV.e7bKIp4Jtv6vK9Wu7Drf7LTtXMTuNuky', '625421', '7e08e821c844b80f3d31b474f2769513.jpg', 'Клиент 20', '87474445566', 940309350448, 'Петрова 13', 'Астана', 'deactivate', '444444444444444444', '2021-03-29 14:00:49', '2021-03-29 14:00:49'),
(51, 'user', 'client21@mail.ru', 'deactivate', '$2a$10$.g5GlvUHpylWsUfYi.x6Bemyf7qeMm2zTQfknrjlI3yAM.43BrCz.', '143917', '2b024b6c4ce15f48d5e7c3ab7a4053de.png', 'Клиент21', '+7 (777) 777 77 77', 940309350448, 'Петрова 13', 'Астана', 'deactivate', '444444444444444444', '2021-03-29 14:01:52', '2021-03-29 14:01:52');
...
--
-- Индексы таблицы `planneds`
--
ALTER TABLE `planneds`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `planneds`
--
ALTER TABLE `planneds`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
